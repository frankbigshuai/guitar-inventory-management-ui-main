...
const host_remote = "https://hw8guitar-latest-1.onrender.com/";
...
async function updateTheNavigationBar() {
    ...
    let loginTag = navigation[navigation.length - 1];
    if(configuration.isLoggedIn()) {
        loginTag.innerHTML =
            `<a  class="nav-item" href="#" onclick="logout()">Logout</a>`;
    } else {
        loginTag.innerHTML = `<a href="login.html" class="nav-item">Login</a>`;
    }
}
